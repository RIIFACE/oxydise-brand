...
export default function DownloadsPage() {
  return (
    <>
        ...
        <div>
          {brand.downloads.map((d) => (
            ...
            >
              ...
              <span className="inline-flex h-9 shrink-0 items-center gap-2 rounded-lg border border-line bg-bg px-3 text-[13px] text-ink">
                Download
      ...
      <p className="max-w-2xl text-[13.5px] leading-[1.55] text-muted">
