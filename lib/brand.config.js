...
const brand = {
  ...
  typography: {
    // Sans-only. Apple-style system stack.
    display: {
      family: 'Inter',
    ...
    sans: {
      ...
      weights: [400, 500, 600],
      usage: 'Body, UI, everywhere else',
    },
    scale: [
      { name: 'Display',  size: '3.5rem',   line: '1.05', tracking: '-0.035em', weight: 600 },
      { name: 'H1',       size: '2.25rem',  line: '1.1',  tracking: '-0.025em', weight: 600 },
      { name: 'H2',       size: '1.75rem',  line: '1.2',  tracking: '-0.02em',  weight: 600 },
      { name: 'H3',       size: '1.25rem',  line: '1.35', tracking: '-0.01em',  weight: 600 },
      { name: 'Body L',   size: '1.0625rem',line: '1.55', tracking: '-0.005em', weight: 400 },
      { name: 'Body',     size: '0.9375rem',line: '1.55', tracking: '0',        weight: 400 },
      { name: 'Caption',  size: '0.8125rem',line: '1.45', tracking: '0',        weight: 500 },
    ],
  },
