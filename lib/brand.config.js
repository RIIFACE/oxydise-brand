...
const brand = {
  ...
  colors: {
    ...
    primary: { name: 'Signal',   hex: '#0071E3', dark: '#0A84FF', rgb: '0 113 227',    darkRgb: '10 132 255',  usage: 'Primary actions, links' },
    accent:  { name: 'Ember',    hex: '#FF6A3D', dark: '#FF7A4D', rgb: '255 106 61',   darkRgb: '255 122 77',  usage: 'Brand accent, highlights' },
  },
