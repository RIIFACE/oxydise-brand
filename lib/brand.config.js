...
const brand = {
  ...
  voice: {
    tone: 'We communicate with clarity and confidence, never urgency or noise.',
    feel: {
      should: ['informed', 'reassured', 'in control of their health decisions'],
    ...
    principles: [
      ...
      {
        name: 'Empathy',
        values: 'Understanding, Not Directive',
        guidelines: [
      ...
      },
      {
        ...
        guidelines: [
          'Make the science accessible, not simplified to the point of losing meaning',
      ...
      },
      {
        ...
        do: ['Advanced, clinically-informed technology—made practical for everyday use'],
      ...
      },
      {
        ...
        dont: [
          'We’re a small team who care a lot',
  ...
  valuesMission: {
    ...
    headlineTail: 'and the values behind it.',
    intro:
      'Our mission is the one sentence that keeps us honest about the long game. Our values steer every decision — what to ship, what to say, how to show up.',
    mission: {
      label: 'Mission',
      statement:
        'To democratise access to advanced wellness technologies, empowering more people to take control of their health and performance.',
    },
  ...
  proposition: {
    ...
    headlineTail: 'and why choose us.',
    definition:
      'A brand proposition is the clear, central idea of why Oxydise exists and why someone should choose us over alternatives. It’s not just what we do — it’s the specific value we promise to deliver, and the reason it matters to our audience.',
    ...
    usage: [
      { label: 'Primary, alone', where: 'Website homepage hero, campaign headers, press boilerplate' },
      { label: 'Primary + support', where: 'About page, investor decks, Google Business description, first-time introductions' },
      { label: 'Support, alone', where: 'Sub-pages, email footers, social bios, 3rd-party site listings' },
      { label: 'Pillars as tags', where: 'Directory listings, partner sites, product navigation' },
    ],
  },
